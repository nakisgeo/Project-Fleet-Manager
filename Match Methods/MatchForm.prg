PARTIAL CLASS MatchForm INHERIT System.Windows.Forms.Form
   ...
   /// </summary>
    PRIVATE METHOD InitializeComponent() AS System.Void
        ...
        SELF:gridControl1:DoubleClick += System.EventHandler{ SELF, @gridControl1_DoubleClick() }
        // 
        // gridView1
        // 
    ...
    PRIVATE METHOD MatchForm_Load( sender AS System.Object, e AS System.EventArgs ) AS System.Void
        ...
        RETURN
	PRIVATE METHOD gridControl1_DoubleClick( sender AS System.Object, e AS System.EventArgs ) AS System.Void
			self:gridControl1_DoubleClick_Method(sender, e)
        RETURN
