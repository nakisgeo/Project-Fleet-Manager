...
#using System.IO
CLASS SelectDatesAdvancedForm INHERIT DevExpress.XtraEditors.XtraForm
    ...
    // For Items Selection
    EXPORT cSqlUids := "" AS System.String
    EXPORT cReportUid AS System.String
    EXPORT cVesselUID AS System.String
    EXPORT oItemsTable AS DataTable
    PRIVATE lSelectionChanged AS System.Boolean
    PRIVATE lLoading AS System.Boolean
    /// <summary>
   ...
   /// </summary>
    PRIVATE METHOD InitializeComponent() AS System.Void
        ...
        SELF:ItemsListView:Location := System.Drawing.Point{12, 78}
        SELF:ItemsListView:Name := "ItemsListView"
        SELF:ItemsListView:Size := System.Drawing.Size{907, 542}
