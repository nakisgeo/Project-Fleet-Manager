...
CLASS ServerNamedPipe IMPLEMENTS System.IDisposable
    ...
    // Methods
    internal  constructor(name as string, outBuffer as DWord, inBuffer as DWord, maxReadBytes as Long, secure as Logic);super()
        //
    ...
    PRIVATE METHOD PipeListener() AS VOID
        LOCAL request, cNamedPipeTag AS STRING
        IF SELF:CheckIfDisposed()
            RETURN
        ENDIF
        TRY
