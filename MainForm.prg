...
PARTIAL CLASS MainForm INHERIT DevExpress.XtraEditors.XtraForm
    ...
    EXPORT LBCVesselReports AS DevExpress.XtraEditors.ListBoxControl
    ...
    EXPORT TreeListVessels AS DevExpress.XtraTreeList.TreeList
    EXPORT TreeListVesselsReports AS DevExpress.XtraTreeList.TreeList
    EXPORT reportsImageList AS System.Windows.Forms.ImageList
    EXPORT voyageTypeImgList AS System.Windows.Forms.ImageList
    ...
    PRIVATE BBIUserGroups AS DevExpress.XtraBars.BarButtonItem
    PRIVATE tabPage1 AS System.Windows.Forms.TabPage
    PRIVATE tabPage2 AS System.Windows.Forms.TabPage
    PRIVATE MainBBIGlobal AS DevExpress.XtraBars.BarButtonItem
    EXPORT LBCReportsOffice AS DevExpress.XtraEditors.ListBoxControl
    EXPORT LBCReportsVessel AS DevExpress.XtraEditors.ListBoxControl
    EXPORT ReportsTabUserControl AS System.Windows.Forms.TabControl
   ...
   /// </summary>
    PRIVATE METHOD InitializeComponent() AS System.Void
        ...
        LOCAL toolTipItem9 := DevExpress.Utils.ToolTipItem{} AS DevExpress.Utils.ToolTipItem
        ...
        SELF:BBIUserGroups := DevExpress.XtraBars.BarButtonItem{}
        ...
        // LBCReportsVessel
        // 
        SELF:LBCReportsVessel:Appearance:Font := System.Drawing.Font{"Lucida Console", ((Single) 8.25)}
        ...
        SELF:ContextMenuStripExportToExcel:Size := System.Drawing.Size{192, 26}
        // 
        // ExportToExcelToolStripMenuItem
        // 
        SELF:ExportToExcelToolStripMenuItem:Name := "ExportToExcelToolStripMenuItem"
        SELF:ExportToExcelToolStripMenuItem:Size := System.Drawing.Size{191, 22}
        ...
        // LBCReportsOffice
        // 
        SELF:LBCReportsOffice:Appearance:Font := System.Drawing.Font{"Lucida Console", ((Single) 8.25)}
        ...
        // LBCVesselReports
        // 
        SELF:LBCVesselReports:Appearance:Font := System.Drawing.Font{"Lucida Console", ((Single) 8.25)}
        ...
        SELF:barManager1:Items:AddRange(<DevExpress.XtraBars.BarItem>{ SELF:BBICheckAll, SELF:BBIShowOnMap, SELF:BBIShowTabForm, SELF:BBIShowMessage, SELF:BBIIsmForm, SELF:BBIImportExcelData, SELF:BBICreateExcelReport, SELF:BBIShowVoyageOnNewMap_Main, SELF:BBIReportDefinition, SELF:barEditItemPeriod, SELF:backBBI, SELF:BBIEditReport, SELF:BBISave, SELF:BBIDelete, SELF:barEditItemDisplayMap, SELF:BBIRefreshReports, SELF:BBIUserGroups, SELF:MainBBIGlobal, SELF:BBICreateReport, SELF:BBIFinalize, SELF:printButton, SELF:BBICancel, SELF:BBIAppove, SELF:BBISubmit, SELF:BBSIStatus, SELF:BBIMyApprovals, SELF:BBIReturn, SELF:barButtonItem2, SELF:barButtonItem3, SELF:BBITableReports, SELF:BBISamosReports, SELF:barButtonItem1, SELF:barButtonItem4, SELF:barButtonItem5, SELF:barButtonItem6, SELF:barButtonItem7, SELF:BBIAppovalHistory, SELF:barButtonItemMRVReport })
        ...
        SELF:BarVessels:LinksPersistInfo:AddRange(<DevExpress.XtraBars.LinkPersistInfo>{ DevExpress.XtraBars.LinkPersistInfo{SELF:BBICheckAll}, DevExpress.XtraBars.LinkPersistInfo{SELF:BBIShowOnMap}, DevExpress.XtraBars.LinkPersistInfo{SELF:BBIImportExcelData}, DevExpress.XtraBars.LinkPersistInfo{SELF:BBIRefreshReports}, DevExpress.XtraBars.LinkPersistInfo{SELF:BBIUserGroups}, DevExpress.XtraBars.LinkPersistInfo{SELF:BBIMyApprovals}, DevExpress.XtraBars.LinkPersistInfo{SELF:MainBBIGlobal}, DevExpress.XtraBars.LinkPersistInfo{SELF:barEditItemDisplayMap} })
        ...
        toolTipTitleItem11:Text := "Check all"
        toolTipItem7:LeftIndent := 6
        toolTipItem7:Text := "Check (select) all Vessels"
        superToolTip11:Items:Add(toolTipTitleItem11)
        superToolTip11:Items:Add(toolTipItem7)
        SELF:BBICheckAll:SuperTip := superToolTip11
        ...
        toolTipTitleItem12:Text := "Show on Map"
        toolTipItem8:LeftIndent := 6
        toolTipItem8:Text := "Show selected Vessels on Map for the highlighted Report"
        superToolTip12:Items:Add(toolTipTitleItem12)
        superToolTip12:Items:Add(toolTipItem8)
        SELF:BBIShowOnMap:SuperTip := superToolTip12
        ...
        toolTipTitleItem13:Text := "Import Excel Data"
        toolTipItem9:LeftIndent := 6
        toolTipItem9:Text := "(Vamvaship only)"
        superToolTip13:Items:Add(toolTipTitleItem13)
        superToolTip13:Items:Add(toolTipItem9)
        SELF:BBIImportExcelData:SuperTip := superToolTip13
        ...
        toolTipTitleItem14:Text := "User Groups Setup"
        superToolTip14:Items:Add(toolTipTitleItem14)
        SELF:BBIRefreshReports:SuperTip := superToolTip14
        SELF:BBIRefreshReports:ItemClick += DevExpress.XtraBars.ItemClickEventHandler{ SELF, @BBIRefreshReports_ItemClick() }
        // 
        // BBIUserGroups
        // 
        SELF:BBIUserGroups:Caption := "User Groups Setup"
        SELF:BBIUserGroups:Id := 17
        SELF:BBIUserGroups:ImageOptions:Image := ((System.Drawing.Image)(resources:GetObject("BBIUserGroups.ImageOptions.Image")))
        SELF:BBIUserGroups:Name := "BBIUserGroups"
        SELF:BBIUserGroups:ItemClick += DevExpress.XtraBars.ItemClickEventHandler{ SELF, @BBIUserGroups_ItemClick() }
        // 
        // BBIMyApprovals
        // 
        ...
        SELF:MainBBIGlobal:ItemAppearance:Normal:Font := System.Drawing.Font{"Tahoma", ((Single) 8.25), System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(161))}
        ...
        SELF:repositoryItemComboBox1:Items:AddRange(<System.Object>{ "100%", "75%", "50%", "25%", "0%" })
        ...
        toolTipTitleItem15:Text := "Show linked message"
        toolTipItem10:LeftIndent := 6
        toolTipItem10:Text := "Switch to Communicator and show the linked message"
        superToolTip15:Items:Add(toolTipTitleItem15)
        superToolTip15:Items:Add(toolTipItem10)
        SELF:BBIShowMessage:SuperTip := superToolTip15
        ...
        toolTipTitleItem16:Text := "Show Report Form"
        superToolTip16:Items:Add(toolTipTitleItem16)
        SELF:BBIShowTabForm:SuperTip := superToolTip16
        ...
        toolTipTitleItem17:Text := e"Show message Body\r\n"
        superToolTip17:Items:Add(toolTipTitleItem17)
        SELF:BBIIsmForm:SuperTip := superToolTip17
        ...
        toolTipTitleItem18:Text := "Create Excel Report"
        toolTipItem11:LeftIndent := 6
        toolTipItem11:Text := "Export Items to Excel file"
        superToolTip18:Items:Add(toolTipTitleItem18)
        superToolTip18:Items:Add(toolTipItem11)
        SELF:BBICreateExcelReport:SuperTip := superToolTip18
        ...
        // 
        SELF:repositoryItemComboBox2:Appearance:BackColor := System.Drawing.Color.FromArgb(((System.Int32)(((System.Byte)(192)))), ((System.Int32)(((System.Byte)(255)))), ((System.Int32)(((System.Byte)(255)))))
        ...
        SELF:repositoryItemComboBox2:Items:AddRange(<System.Object>{ "Last 6 Months", "Voyage routing", "Specific date period" })
        ...
        toolTipTitleItem19:Text := "Custom Reports"
        toolTipItem12:LeftIndent := 6
        toolTipItem12:Text := "Custom Reports Definition and execution"
        superToolTip19:Items:Add(toolTipTitleItem19)
        superToolTip19:Items:Add(toolTipItem12)
        SELF:BBIReportDefinition:SuperTip := superToolTip19
        ...
        toolTipTitleItem20:Text := e"Show selected Voyage routing on a new full functional Map\r\n"
        superToolTip20:Items:Add(toolTipTitleItem20)
        SELF:BBIShowVoyageOnNewMap_Main:SuperTip := superToolTip20
        ...
        // hideContainerLeft
        // 
        SELF:hideContainerLeft:BackColor := System.Drawing.Color.FromArgb(((System.Int32)(((System.Byte)(253)))), ((System.Int32)(((System.Byte)(253)))), ((System.Int32)(((System.Byte)(253)))))
