...
PARTIAL CLASS VoyagesForm INHERIT System.Windows.Forms.Form
    EXPORT GridViewRoutings AS DevExpress.XtraGrid.Views.Grid.GridView
    PRIVATE GridVoyages AS DevExpress.XtraGrid.GridControl
    EXPORT GridViewVoyages AS DevExpress.XtraGrid.Views.Grid.GridView
    ...
    EXPORT LookUpEditCompany_Voyages AS DevExpress.XtraEditors.LookUpEdit
    PRIVATE label12 AS System.Windows.Forms.Label
    EXPORT LBSuggest AS DevExpress.XtraEditors.ListBoxControl
    ...
    EXPORT routingDetails1 AS RoutingDetails
   ...
   /// </summary>
    PRIVATE METHOD InitializeComponent() AS System.Void
        ...
        SELF:GridVoyages:Size := System.Drawing.Size{1000, 636}
        ...
        SELF:barManager:Items:AddRange(<DevExpress.XtraBars.BarItem>{ SELF:BBIAdd, SELF:BBIEdit, SELF:BBIDelete, SELF:BBIRefresh, SELF:BBIPrint, SELF:BBINewRouting, SELF:BBILog, SELF:BBICalculateROB, SELF:BBIClose, SELF:BBIAttachments, SELF:BBIMWA, SELF:BBIMWD, SELF:bbiMRVVoyageReport })
        SELF:barManager:MainMenu := SELF:barVoyages
        SELF:barManager:MaxItemId := 14
        // 
        // barVoyages
        // 
